  ...
  return (
    <LegalPageLayout title="환불 정책" description="암기훈련소 서비스의 환불 정책입니다">
      <div className="space-y-8">
        <section>
          <p className="mb-4">
            앱돌이공장(이하 '회사')은 이용자의 권익을 보호하고 서비스 이용 관련 분쟁을 원활하게 해결하기 위해 다음과 같이 환불 정책을 운영하고 있습니다. 본 환불 정책은 암기훈련소 서비스의 유료 서비스 이용과 관련된 환불 및 취소에 대한 기준과 절차를 설명합니다.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mb-4">
            본 환불 정책은 2025년 2월 24일부터 시행됩니다. 회사는 필요한 경우 환불 정책을 변경할 수 있으며, 변경된 환불 정책은 서비스 내 공지사항을 통해 공지합니다. 변경된 환불 정책은 공지일로부터 7일 후부터 효력이 발생합니다.
          </p>
        </section>
      </div>
    </LegalPageLayout>
